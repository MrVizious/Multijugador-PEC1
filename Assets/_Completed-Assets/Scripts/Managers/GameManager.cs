...
namespace Complete
{
    public class GameManager : MonoBehaviour
    {
        ...
        private void Start() {
            ...
            numberOfActiveTanks = numberOfPlayers;
        ...
        private void Update() {
            SetCameraTargets();
            UpdateNumberOfActiveTanks();
            ResetCameras();
        }

        private void UpdateNumberOfActiveTanks() {
        ...
        private void SpawnAllTanks() {
            ...
            // For all the tanks...
            for (int i = 0; i < numberOfActiveTanks; i++)
            {
        ...
        public void AddPlayer() {
            ...
            numberOfPlayers++;
            numberOfActiveTanks++;
            SpawnTank(numberOfActiveTanks - 1);
            Camera newTankCam = m_Tanks[numberOfActiveTanks - 1].m_Instance.transform.GetComponentInChildren<Camera>();
            newTankCam.cullingMask = -1;
            newTankCam.orthographicSize = 10;
            ...
            if (numberOfActiveTanks == 2)
            {
                ...
                for (int i = 0, count = 0; i < numberOfPlayers && count < 2; i++)
                {
                    if (m_Tanks[i].m_Instance.activeSelf)
                    {
                        ...
                        {
                            newRect = new Rect(0f, 0f, 1f, 0.5f);
                        }

                        m_Tanks[i].m_Instance.transform.GetComponentInChildren<Camera>().rect = newRect;
                        count++;
                    }
                }
            }
            else if (numberOfActiveTanks == 3)
            {
                ...
                for (int i = 0, count = 0; i < numberOfPlayers && count < 3; i++)
                {
                    if (m_Tanks[i].m_Instance.activeSelf)
                    {
                        ...
                        {
                            newRect = new Rect(0f, 0f, 0.5f, 0.5f);
                        }
                        else if (count == 2)
                        {
                            newRect = new Rect(0.5f, 0f, 0.5f, 0.5f);
                        }
            ...
            else if (numberOfActiveTanks == 4)
            {
                ...
                for (int i = 0, count = 0; i < numberOfPlayers && count < 4; i++)
                {
                    if (m_Tanks[i].m_Instance.activeSelf)
                    {
                        ...
                        {
                            newRect = new Rect(0.5f, 0.5f, 0.5f, 0.5f);
                        }
