...
namespace Complete
{
    public class CameraControl : MonoBehaviour
    {
        ...
        public float limitDist = 55.0f;                 // Distance limit
        public float hysteresis = 15.0f;                 // Hysteresis
        ...
        private void Split() {
            ...
            float distance = GetLargestDistance();
        ...
        private float GetLargestDistance() {
            ...
            for (int i = 0; i < m_Targets.Length; i++)
            {
                if (m_Targets[i].gameObject.activeSelf)
                {
                    ...
                    {
                        distance += Vector3.Distance(m_Targets[i].position, m_Targets[j].position);
                    }
                }
            }
            distance /= activeTanks;
            Debug.Log("Average distance is:" + distance);
            return distance;
        }
